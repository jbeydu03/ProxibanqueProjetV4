...
INSERT INTO AGENCE (id, numero, date) VALUES ('1', 'AG001', '01/01/2018');
...
INSERT INTO COMPTE (id, numero, solde, date) VALUES ('1', '1234567890', '1000.00', '01/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('1', '-2600.00', '1');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('2', '2345678901', '2000.00', '02/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('2', '-1000.00', '2');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('3', '3456789012', '3000.00', '03/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('3', '-1000.00', '3');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('4', '4567890123', '4000.00', '04/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('4', '-1000.00', '4');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('5', '5678901234', '5000.00', '05/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('5', '-1000.00', '5');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('6', '6789012345', '-6000.00', '06/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('6', '-10000.00', '6');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('7', '7890123456', '7000.00', '07/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('7', '-1000.00', '7');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('8', '8901234567', '8000.00', '08/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('8', '-1000.00', '8');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('9', '9012345678', '9000.00', '09/01/2018');
INSERT INTO COMPTECOURANT (id, decouvert, carte_id) VALUES ('9', '-1000.00', '9');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('10', '0123456789', '-10000.00', '10/01/2018');
...
INSERT INTO COMPTE (id, numero, solde, date) VALUES ('11','0000000001', '1000',  '01/01/2018');
INSERT INTO COMPTEEPARGNE (id, taux) VALUES ('11', '0.01');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('13','0000000003', '3000',  '01/03/2018');
INSERT INTO COMPTEEPARGNE (id, taux) VALUES ('13', '0.03');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('15', '0000000005','5000',  '01/05/2018');
INSERT INTO COMPTEEPARGNE (id, taux) VALUES ('15', '0.05');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('17', '0000000007','7000',  '01/07/2018');
INSERT INTO COMPTEEPARGNE (id, taux) VALUES ('17', '0.07');

INSERT INTO COMPTE (id, numero, solde, date) VALUES ('19','0000000009', '9000',  '01/09/2018');
...
INSERT INTO VIREMENT (id, date, comptedebit_id, comptecredit_id, montant) VALUES ('1', '03/01/2018', '1', '11', '4000');